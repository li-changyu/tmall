									...
									<c:forEach items="${o.orderItems}" var="oi">
										<tr>
                                            ...
                                            <td align="right">
												...
												<span class="text-muted">地址：${o.address}</span>												
											</td>
                                            <td align="right">
											
												<span class="text-muted">订单编号：${o.orderCode}</span>												
											</td>	
                                            <td align="right">
											
												<span class="text-muted">联系电话：${o.mobile}</span>												
											</td>												
                                            <td align="right">
											
												<span class="text-muted">邮编：${o.post}</span>												
											</td>																					
										</tr>
									</c:forEach>
